...
Every slide is a `<section>` containing a `.sv2-slide-surface` element:
...
SlidesV2.generateSlideId()  // Returns: "slide-c1a2b3c4d5..."
```
...
| Class | Purpose |
|-------|---------|
| `sv2-slide-surface` | Main content container (required) |
...
<div class="reveal">
  <div class="slides">
    ...
    <section data-slide-kind="cover">
      <div class="sv2-slide-surface" data-slide-id="slide-cover" data-slide-title="Cover">
    ...
    <!-- Slide 1 -->
    <section>
      <div class="sv2-slide-surface" data-slide-id="slide-intro" data-slide-title="Introduction">
        <h2>Introduction</h2>
    ...
    <!-- Slide 2 -->
    <section>
      <div class="sv2-slide-surface" data-slide-id="slide-main" data-slide-title="Main Content">
        <h2>Main Content</h2>
